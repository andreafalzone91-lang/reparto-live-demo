...
let appState;
try { appState = JSON.parse(localStorage.getItem('reparto-demo-state')) || initial(); } catch { appState = initial(); }
let selected = 'KD';
...
function save(){localStorage.setItem('reparto-demo-state',JSON.stringify(appState))}
