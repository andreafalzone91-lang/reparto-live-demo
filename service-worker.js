const CACHE = 'reparto-live-v143';
const FILES = ['./', './index.html', './styles.css', './auth.css', './design-v76.css', './serioplast-v95.css', './supabase.js', './codifica-catalog.js', './app.js', './manifest.json', './icon-192.png', './icon-512.png', './apple-touch-icon.png', './brand-bottle.png', './brand-logo.jpg', './brand-pattern.jpg', './assets/forklifts/muletto-checklist.png', './assets/transpallet/transpallet-elettrico-tipo-1.png', './assets/transpallet/transpallet-elettrico-piccolo.png', './assets/machines/sidel-checklist.png', './assets/machines/magic-checklist.png'];
