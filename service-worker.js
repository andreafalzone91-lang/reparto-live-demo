const CACHE = 'reparto-live-v92';
const FILES = ['./', './index.html', './styles.css', './auth.css', './design-v76.css', './supabase.js', './app.js', './manifest.json', './icon.svg', './brand-bottle.png', './brand-logo.jpg', './brand-pattern.jpg'];
